...
*   **Bespoke Report Templates:** firm-specific PDF designs.
*   **AI Logic Protection:** Moving the core prompts and valuation logic behind a protected ELK Digital API.

### Phase 5: Commercial SaaS Launch
*   **Subscription Engine:** Implementation of 12-month term enforcement and automated billing.
*   **Pricing Strategy:** Positioning as a premium mid-market alternative at £250/month (vs £500/month competitors).
*   **Usage-Based Auditing:** Tracking extraction volume per firm to manage AI API costs and profitability.
