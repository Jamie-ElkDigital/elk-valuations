...
try {
    ...
    // Estimate cost: $15 per 1M tokens (Rough average for Gemini 1.5 Pro)
    $estCost = ($totalTokens / 1000000) * 15;
...
<div class="app-wrapper">
  <main class="main" style="max-width: 1200px; margin: 0 auto; padding: 40px;">
    ...
    <h2 class="section-title">Firm Profitability &amp; Usage</h2>
    <table>
        <thead>
            <tr>
                <th>Firm Name</th>
        ...
        <tbody>
            ...
            <tr class="firm-row">
                ...
                <td>$<?php echo number_format(($f['firm_tokens'] / 1000000) * 15, 4); ?></td>
